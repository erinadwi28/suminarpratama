<div class="container-fluid ">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/caro/carosel1.jpg" class="d-block w-100" alt="..." height="500px">
    </div>
    <div class="carousel-item">
      <img src="assets/caro/carosel2.png" class="d-block w-100" alt="..." height="500px">
    </div>
    <div class="carousel-item">
      <img src="assets/caro/carosel3.png" class="d-block w-100" alt="..." height="500px">
    </div>
  </div>
...
<div class="row ml-3 text-center " >
  ...
  <div class="card mr-2 mt-3 " style="width: 16rem;">
  ...
  <div class="card-body">
    ...
    <p class="card-text" style="color: black"><?php echo $brt->keterangan ?></p>
  </div>
  </a>
</div>
